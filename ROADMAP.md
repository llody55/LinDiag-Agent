...
（详见 [CHANGELOG.md](CHANGELOG.md) v4.2.0）
...
### 1. main.go 信号处理与优雅退出 — ✅ v4.2.0 已解决
...
### 2. safety.splitCommandChain 引号绕过 — ✅ v4.2.0 已解决
...
### 3. 管道末段 bash 不递归分析左侧输入 — ✅ v4.2.0 已解决
...
### 4. LoadWhitelist / 全局可变状态 data race — ✅ v4.2.0 已解决
...
### 8. sudo -i/-s 与 xargs -I 误判 — ✅ v4.2.0 已解决
...
### 10. LLM 重试无退避 + 错误判定脆弱 — ✅ v4.2.0 已解决
...
### 11. Session.WithLLMClient 未同步到 handler — ✅ v4.2.0 已解决
...
### 12. baseSnapshotCmds 命令注入扩展点 — ✅ v4.2.0 已解决
...
### 13. readUserAction / handleReportRequest 不检查 ctx — ✅ v4.2.0 已解决
...
### 15. executor.go 超时分支 data race — ✅ v4.2.0 已解决
...
### 16. rules 僵尸进程误判 + conntrack 误报 — ✅ v4.2.0 已解决
...
### 17. report.Generate* 错误不冒泡 — ✅ v4.2.0 已解决
...
### 28. handleAIFailure 无限重试 — ✅ v4.2.0 已解决
